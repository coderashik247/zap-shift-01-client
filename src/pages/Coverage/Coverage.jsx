...
const Coverage = () => {
  ...
  return (
    <div className="my-10">
      <h2 className="text-secondary font-medium text-4xl text-center mb-5">
      ...
      <div>
        <form onSubmit={handleSearch} className="text-center mb-5">
          <label className="input ">
            ...
            <input type="search" className="grow" placeholder="Search your location" name="location"/>
          </label>
        </form>
      </div>
      <div className="border w-full h-220">
        <MapContainer
          center={position}
          zoom={7.5}
